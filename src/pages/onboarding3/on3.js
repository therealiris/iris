...
var OnboardingThree = /** @class */ (function () {
    function OnboardingThree(navCtrl, navParams, viewCtrl) {
    ...
    OnboardingThree.prototype.initializeItems = function () {
    ...
    OnboardingThree.prototype.getItems = function (ev) {
    ...
    OnboardingThree.prototype.updateList = function (item, value) {
    ...
    OnboardingThree.prototype.passSkills = function () {
        this.viewCtrl.dismiss({ "skillsList": this.selectedList });
    };
    OnboardingThree = __decorate([
        Component({
            selector: 'on-three',
